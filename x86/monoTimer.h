...
static inline
uint32_t monomillis(){
//	std::cout << "monomillis:"<<std::chrono::duration_cast<std::chrono::milliseconds>(std::chrono::system_clock::now().time_since_epoch()).count()<<std::endl;
...
static mutex tasksmutex, waitmutex;
